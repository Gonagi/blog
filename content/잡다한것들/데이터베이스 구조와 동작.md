...
---
## 2. DB 동작 방식
![|349](https://i.imgur.com/yhOwFtd.png)
1. 사용자 → 어플리케이션 요청
2. 어플리케이션 → 쿼리 생성
	- 쿼리: 데이터 조회·수정 요청(SQL)
...
예시:
 - ER Diagram(Entity-Relationship Model)![|403](https://i.imgur.com/H6Qn4Q4.png)
...
예시:
- Relation Model
	![|283](https://i.imgur.com/BW82Rmd.png)
...
- DB 설계 시 결정되며 **자주 변경되지 않음**
	![|393](https://i.imgur.com/PYORWxg.png)
### 4.2 Database State
...
![|437](https://i.imgur.com/QyOhYjL.png)
